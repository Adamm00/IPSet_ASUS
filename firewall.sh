...
Is_PrivateIP() {
	grep -qE '(^100\.(6[4-9]|[7-9][0-9]|1[0-1][0-9]|12[0-7])\.)|(^127\.)|(^10\.)|(^172\.1[6-9]\.)|(^172\.2[0-9]\.)|(^172\.3[0-1]\.)|(^192\.168\.)|(^0.)|(^169\.254\.)|(^22[4-9]\.)|(^23[0-9]\.)|(^255\.255\.255\.255)'
}

Filter_PrivateIP() {
	grep -vE '(^100\.(6[4-9]|[7-9][0-9]|1[0-1][0-9]|12[0-7])\.)|(^127\.)|(^10\.)|(^172\.1[6-9]\.)|(^172\.2[0-9]\.)|(^172\.3[0-1]\.)|(^192\.168\.)|(^0.)|(^169\.254\.)|(^22[4-9]\.)|(^23[0-9]\.)|(^255\.255\.255\.255)|(^8\.8\.8\.8)|(^8\.8\.4\.4)|(^1\.1\.1\.1)|(^1\.0\.0\.1)'
}
