...
Is_PrivateIP() {
	grep -qE '^(0.|10\.|100\.(6[4-9]|[7-9][0-9]|1[0-1][0-9]|12[0-7])\.|127\.|169\.254\.|172\.1[6-9]\.|172\.2[0-9]\.|172\.3[0-1]\.|192\.0\.0|192\.168\.|198\.(1[8-9])\.|22[4-9]\.|23[0-9]\.|255\.255\.255\.255)'
}
...
Filter_PrivateSRC() {
	grep -E 'SRC=(0.|10\.|100\.(6[4-9]|[7-9][0-9]|1[0-1][0-9]|12[0-7])\.|127\.|169\.254\.|172\.1[6-9]\.|172\.2[0-9]\.|172\.3[0-1]\.|192\.0\.0|192\.168\.|198\.(1[8-9])\.|22[4-9]\.|23[0-9]\.|255\.255\.255\.255)'
}

Filter_PrivateDST() {
	grep -E 'DST=(0.|10\.|100\.(6[4-9]|[7-9][0-9]|1[0-1][0-9]|12[0-7])\.|127\.|169\.254\.|172\.1[6-9]\.|172\.2[0-9]\.|172\.3[0-1]\.|192\.0\.0|192\.168\.|198\.(1[8-9])\.|22[4-9]\.|23[0-9]\.|255\.255\.255\.255)'
}
