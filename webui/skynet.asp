    ...
    <script>
        ...
        function Draw_Chart(txtchartname, multilabel) {
            ...
            if (multilabel == "true") {
                ...
                if (typeof objlabeldataname_IPs === 'undefined' || objlabeldataname_IPs === null) {
                    Draw_Chart_NoData(txtchartname);
                    return;
                }
                ...
                if (typeof objlabeldataname_Sorted === 'undefined' || objlabeldataname_Sorted === null) {
                    Draw_Chart_NoData(txtchartname);
                    return;
                }
        ...
        function getAvg(datasetname) {
            ...
            if (datasetname.length) {
                sum = datasetname.reduce(function(a, b) {
                    return a * 1 + b * 1;
                });
